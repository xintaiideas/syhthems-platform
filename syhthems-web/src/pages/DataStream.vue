<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  ...
  >
    <v-flex sm12>
      <v-card>
        <v-toolbar class="mb-2">
          ...
          <v-spacer />
          <v-toolbar-title>终端费用信息</v-toolbar-title>
          <v-spacer />
          <v-btn
            icon
          ...
          >
            <template v-slot:header="">
              <v-toolbar
                class="mb-2"
              >
                <v-toolbar-title>费用信息列表</v-toolbar-title>
                <v-spacer />
                <v-dialog
                ...
                >
                  ...
                  <v-card>
                    <v-card-title>
                      <span class="headline">添加费用信息</span>
                    </v-card-title>
                    <v-card-text>
                      <v-form
              ...
              >
                <v-card>
                  <v-list dense>
                    ...
                    <v-divider />
                    <v-list-tile>
                      <v-list-tile-content>费用单位： </v-list-tile-content>
                    ...
                    <v-divider />
                    <v-list-tile>
                      <v-list-tile-content>费用单位符号：</v-list-tile-content>
                      <v-list-tile-content class="align-end">
    ...
    >
      <v-card>
        <v-card-title>
          <span class="headline">修改费用流</span>
        </v-card-title>
        <v-card-text>
          <v-form
