          ...
          <template v-slot:item="props">
            ...
            >
              <v-card>
                ...
                <v-list dense>
                  <v-list-tile>
                    <v-list-tile-content>产品名称:</v-list-tile-content>
                    <v-list-tile-content class="align-end">
                      {{ isEmpty(props.item.devices) ? 0 : props.item.devices.length }} 个
                    </v-list-tile-content>
                  </v-list-tile>
                  <v-list-tile>
                    <v-list-tile-content>产品类别:</v-list-tile-content>
                    <v-list-tile-content class="align-end">
                      {{ isEmpty(props.item.devices) ? 0 : props.item.devices.length }} 个
                    </v-list-tile-content>
                  </v-list-tile>
                  <v-list-tile>
                    <v-list-tile-content>设备序列号:</v-list-tile-content>
                    <v-list-tile-content class="align-end">
                      {{ isEmpty(props.item.devices) ? 0 : props.item.devices.length }} 个
                    </v-list-tile-content>
                  </v-list-tile>
                  <v-list-tile>
                    <v-list-tile-content>终端厂家:</v-list-tile-content>
                    <v-list-tile-content class="align-end">
                      {{ isEmpty(props.item.devices) ? 0 : props.item.devices.length }} 个
                    </v-list-tile-content>
                  </v-list-tile>
                  <v-list-tile>
                    <v-list-tile-content>安装位置:</v-list-tile-content>
                    <v-list-tile-content class="align-end">
                      {{ isEmpty(props.item.devices) ? 0 : props.item.devices.length }} 个
                    </v-list-tile-content>
                  </v-list-tile>
